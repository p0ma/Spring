...
public class BorerMethodChartBuilder implements ChartBuilder {

    private ParametersModel parametersModel;

    public BorerMethodChartBuilder(ParametersModel parametersModel) {
    ...
    public IChart getChart() {
        ...
        chartImpl.setHeader(LocalizationUtils.getMessage("chart.borerMethod.header"));
        ...
        chartImpl.addPoint(new DPoint(pumpTurnsForAnnularSpace, cycleBeginningPressure));
        ...
        chartImpl.addPoint(new DPoint(2 * pumpTurnsForAnnularSpace + pumpTurns, cycleEndingPressure));
        return chartImpl;
    }
}
