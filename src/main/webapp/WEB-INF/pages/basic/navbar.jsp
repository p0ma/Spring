            ...
            <ul class="nav navbar-nav">
                <sec:authorize access="isAuthenticated()">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="${pageContext.request.contextPath}/well/add_form">
                                <spring:message code="pipeSection.add"/></a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/well/delete_form">
                                <spring:message code="pipeSection.delete"/>
                            </a></li>
                            <li class="divider"></li>
                            <li><a href="${pageContext.request.contextPath}/well/pipe_sections">
                                <spring:message code="pipeSection.list"/></a>
                            </li>
                        </ul>
                    </li>
                </sec:authorize>
