...
<html>
<head>
    <title><spring:message code="well"/></title>
    ...
    <script type="text/javascript">
        function deletePipeSection(id) {
            ...
            $.ajax({
                method: 'DELETE',
                url: "${pageContext.request.contextPath}/well/delete.json",
...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><spring:message code="pipeSection.delete"/></h3>
        </div>
